...
type FailoverCallRemote2 struct {
	...
	Callback  NullableCallback `json:"callback,omitempty"`
}
...
// SetCallback gets a reference to the given NullableCallback and assigns it to the Callback field.
func (o *FailoverCallRemote2) SetCallback(v Callback) {
	o.Callback.Set(&v)
}

// SetCallbackNil sets the value for Callback to be an explicit nil
func (o *FailoverCallRemote2) SetCallbackNil() {
	o.Callback.Set(nil)
}
