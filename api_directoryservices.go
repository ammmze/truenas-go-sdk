...
type DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest struct {
	ctx        context.Context
	ApiService *DirectoryservicesApiService
}

func (r DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest) Execute() (*http.Response, error) {
...
with users being unable to authenticate to shares.
 ...
 @return DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest
*/
func (a *DirectoryservicesApiService) DirectoryservicesCacheRefreshGet(ctx context.Context) DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest {
	return DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DirectoryservicesApiService) DirectoryservicesCacheRefreshGetExecute(r DirectoryservicesApiDirectoryservicesCacheRefreshGetRequest) (*http.Response, error) {
	var (
...
type DirectoryservicesApiDirectoryservicesGetStateGetRequest struct {
	ctx        context.Context
	ApiService *DirectoryservicesApiService
}

func (r DirectoryservicesApiDirectoryservicesGetStateGetRequest) Execute() (*http.Response, error) {
...
`HEALTHY` Directory Service is enabled, and last status check has passed.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return DirectoryservicesApiDirectoryservicesGetStateGetRequest
*/
func (a *DirectoryservicesApiService) DirectoryservicesGetStateGet(ctx context.Context) DirectoryservicesApiDirectoryservicesGetStateGetRequest {
	return DirectoryservicesApiDirectoryservicesGetStateGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *DirectoryservicesApiService) DirectoryservicesGetStateGetExecute(r DirectoryservicesApiDirectoryservicesGetStateGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
