...
func NewUserCreate0() *UserCreate0 {
	this := UserCreate0{}
	var groupCreate bool = false
	this.GroupCreate = &groupCreate
	var home string = "/nonexistent"
	this.Home = &home
	var homeMode string = "755"
	this.HomeMode = &homeMode
	var shell string = "/usr/bin/zsh"
	this.Shell = &shell
	var passwordDisabled bool = false
	this.PasswordDisabled = &passwordDisabled
	var locked bool = false
	this.Locked = &locked
	var microsoftAccount bool = false
	this.MicrosoftAccount = &microsoftAccount
	var smb bool = true
	this.Smb = &smb
	var sudo bool = false
	this.Sudo = &sudo
	var sudoNopasswd bool = false
