...
type FtpApiFtpGetRequest struct {
	ctx        context.Context
	ApiService *FtpApiService
}

func (r FtpApiFtpGetRequest) Execute() (*http.Response, error) {
...
FtpGet Method for FtpGet
 ...
 @return FtpApiFtpGetRequest
*/
func (a *FtpApiService) FtpGet(ctx context.Context) FtpApiFtpGetRequest {
	return FtpApiFtpGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *FtpApiService) FtpGetExecute(r FtpApiFtpGetRequest) (*http.Response, error) {
	var (
...
type FtpApiFtpPutRequest struct {
	ctx        context.Context
	ApiService *FtpApiService
	ftpUpdate0 *FtpUpdate0
}

func (r FtpApiFtpPutRequest) FtpUpdate0(ftpUpdate0 FtpUpdate0) FtpApiFtpPutRequest {
	r.ftpUpdate0 = &ftpUpdate0
	return r
}

func (r FtpApiFtpPutRequest) Execute() (*http.Response, error) {
...
`options` is a string used to add proftpd(8) parameters not covered by ftp service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return FtpApiFtpPutRequest
*/
func (a *FtpApiService) FtpPut(ctx context.Context) FtpApiFtpPutRequest {
	return FtpApiFtpPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *FtpApiService) FtpPutExecute(r FtpApiFtpPutRequest) (*http.Response, error) {
	var (
