...
type WebdavApiWebdavCertChoicesGetRequest struct {
	ctx        context.Context
	ApiService *WebdavApiService
}

func (r WebdavApiWebdavCertChoicesGetRequest) Execute() (*http.Response, error) {
...
Permitted certificate choices for webdav service.
 ...
 @return WebdavApiWebdavCertChoicesGetRequest
*/
func (a *WebdavApiService) WebdavCertChoicesGet(ctx context.Context) WebdavApiWebdavCertChoicesGetRequest {
	return WebdavApiWebdavCertChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *WebdavApiService) WebdavCertChoicesGetExecute(r WebdavApiWebdavCertChoicesGetRequest) (*http.Response, error) {
	var (
...
type WebdavApiWebdavGetRequest struct {
	ctx        context.Context
	ApiService *WebdavApiService
}

func (r WebdavApiWebdavGetRequest) Execute() (*http.Response, error) {
...
WebdavGet Method for WebdavGet
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebdavApiWebdavGetRequest
*/
func (a *WebdavApiService) WebdavGet(ctx context.Context) WebdavApiWebdavGetRequest {
	return WebdavApiWebdavGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *WebdavApiService) WebdavGetExecute(r WebdavApiWebdavGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type WebdavApiWebdavPutRequest struct {
	ctx           context.Context
	ApiService    *WebdavApiService
	webdavUpdate0 *WebdavUpdate0
}

func (r WebdavApiWebdavPutRequest) WebdavUpdate0(webdavUpdate0 WebdavUpdate0) WebdavApiWebdavPutRequest {
	r.webdavUpdate0 = &webdavUpdate0
	return r
}

func (r WebdavApiWebdavPutRequest) Execute() (*http.Response, error) {
...
`htauth` should be one of the valid types described above.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebdavApiWebdavPutRequest
*/
func (a *WebdavApiService) WebdavPut(ctx context.Context) WebdavApiWebdavPutRequest {
	return WebdavApiWebdavPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *WebdavApiService) WebdavPutExecute(r WebdavApiWebdavPutRequest) (*http.Response, error) {
	var (
