...
func NewFormatOptions() *FormatOptions {
	this := FormatOptions{}
	var canonicalize bool = false
	this.Canonicalize = &canonicalize
	var ensureBuiltins bool = false
	this.EnsureBuiltins = &ensureBuiltins
	var resolveNames bool = false
