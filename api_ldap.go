...
type LdapApiLdapGetRequest struct {
	ctx        context.Context
	ApiService *LdapApiService
}

func (r LdapApiLdapGetRequest) Execute() (*http.Response, error) {
...
LdapGet Method for LdapGet
 ...
 @return LdapApiLdapGetRequest
*/
func (a *LdapApiService) LdapGet(ctx context.Context) LdapApiLdapGetRequest {
	return LdapApiLdapGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LdapApiService) LdapGetExecute(r LdapApiLdapGetRequest) (*http.Response, error) {
	var (
...
type LdapApiLdapGetStateGetRequest struct {
	ctx        context.Context
	ApiService *LdapApiService
}

func (r LdapApiLdapGetStateGetRequest) Execute() (*http.Response, error) {
...
LDAP service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return LdapApiLdapGetStateGetRequest
*/
func (a *LdapApiService) LdapGetStateGet(ctx context.Context) LdapApiLdapGetStateGetRequest {
	return LdapApiLdapGetStateGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *LdapApiService) LdapGetStateGetExecute(r LdapApiLdapGetStateGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type LdapApiLdapPutRequest struct {
	ctx         context.Context
	ApiService  *LdapApiService
	ldapUpdate0 *LdapUpdate0
}

func (r LdapApiLdapPutRequest) LdapUpdate0(ldapUpdate0 LdapUpdate0) LdapApiLdapPutRequest {
	r.ldapUpdate0 = &ldapUpdate0
	return r
}

func (r LdapApiLdapPutRequest) Execute() (*http.Response, error) {
...
LDAP server.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return LdapApiLdapPutRequest
*/
func (a *LdapApiService) LdapPut(ctx context.Context) LdapApiLdapPutRequest {
	return LdapApiLdapPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *LdapApiService) LdapPutExecute(r LdapApiLdapPutRequest) (*http.Response, error) {
	var (
...
type LdapApiLdapSchemaChoicesGetRequest struct {
	ctx        context.Context
	ApiService *LdapApiService
}

func (r LdapApiLdapSchemaChoicesGetRequest) Execute() (*http.Response, error) {
...
Returns list of available LDAP schema choices.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return LdapApiLdapSchemaChoicesGetRequest
*/
func (a *LdapApiService) LdapSchemaChoicesGet(ctx context.Context) LdapApiLdapSchemaChoicesGetRequest {
	return LdapApiLdapSchemaChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *LdapApiService) LdapSchemaChoicesGetExecute(r LdapApiLdapSchemaChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type LdapApiLdapSslChoicesGetRequest struct {
	ctx        context.Context
	ApiService *LdapApiService
}

func (r LdapApiLdapSslChoicesGetRequest) Execute() (*http.Response, error) {
...
Returns list of SSL choices.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return LdapApiLdapSslChoicesGetRequest
*/
func (a *LdapApiService) LdapSslChoicesGet(ctx context.Context) LdapApiLdapSslChoicesGetRequest {
	return LdapApiLdapSslChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *LdapApiService) LdapSslChoicesGetExecute(r LdapApiLdapSslChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
