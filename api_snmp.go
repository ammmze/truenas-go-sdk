...
type SnmpApiSnmpGetRequest struct {
	ctx        context.Context
	ApiService *SnmpApiService
}

func (r SnmpApiSnmpGetRequest) Execute() (*http.Response, error) {
...
SnmpGet Method for SnmpGet
 ...
 @return SnmpApiSnmpGetRequest
*/
func (a *SnmpApiService) SnmpGet(ctx context.Context) SnmpApiSnmpGetRequest {
	return SnmpApiSnmpGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SnmpApiService) SnmpGetExecute(r SnmpApiSnmpGetRequest) (*http.Response, error) {
	var (
...
type SnmpApiSnmpPutRequest struct {
	ctx         context.Context
	ApiService  *SnmpApiService
	snmpUpdate0 *SnmpUpdate0
}

func (r SnmpApiSnmpPutRequest) SnmpUpdate0(snmpUpdate0 SnmpUpdate0) SnmpApiSnmpPutRequest {
	r.snmpUpdate0 = &snmpUpdate0
	return r
}

func (r SnmpApiSnmpPutRequest) Execute() (*http.Response, error) {
...
is enabled.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SnmpApiSnmpPutRequest
*/
func (a *SnmpApiService) SnmpPut(ctx context.Context) SnmpApiSnmpPutRequest {
	return SnmpApiSnmpPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SnmpApiService) SnmpPutExecute(r SnmpApiSnmpPutRequest) (*http.Response, error) {
	var (
