...
type TftpApiTftpGetRequest struct {
	ctx        context.Context
	ApiService *TftpApiService
}

func (r TftpApiTftpGetRequest) Execute() (*http.Response, error) {
...
TftpGet Method for TftpGet
 ...
 @return TftpApiTftpGetRequest
*/
func (a *TftpApiService) TftpGet(ctx context.Context) TftpApiTftpGetRequest {
	return TftpApiTftpGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *TftpApiService) TftpGetExecute(r TftpApiTftpGetRequest) (*http.Response, error) {
	var (
...
type TftpApiTftpHostChoicesGetRequest struct {
	ctx        context.Context
	ApiService *TftpApiService
}

func (r TftpApiTftpHostChoicesGetRequest) Execute() (*http.Response, error) {
...
Return host choices for TFTP service to use.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return TftpApiTftpHostChoicesGetRequest
*/
func (a *TftpApiService) TftpHostChoicesGet(ctx context.Context) TftpApiTftpHostChoicesGetRequest {
	return TftpApiTftpHostChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *TftpApiService) TftpHostChoicesGetExecute(r TftpApiTftpHostChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type TftpApiTftpPutRequest struct {
	ctx         context.Context
	ApiService  *TftpApiService
	tftpUpdate0 *TftpUpdate0
}

func (r TftpApiTftpPutRequest) TftpUpdate0(tftpUpdate0 TftpUpdate0) TftpApiTftpPutRequest {
	r.tftpUpdate0 = &tftpUpdate0
	return r
}

func (r TftpApiTftpPutRequest) Execute() (*http.Response, error) {
...
has access to `directory`.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return TftpApiTftpPutRequest
*/
func (a *TftpApiService) TftpPut(ctx context.Context) TftpApiTftpPutRequest {
	return TftpApiTftpPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *TftpApiService) TftpPutExecute(r TftpApiTftpPutRequest) (*http.Response, error) {
	var (
