...
type SmbSharesecApiSmbSharesecGetRequest struct {
	ctx        context.Context
...
func (r SmbSharesecApiSmbSharesecGetRequest) Limit(limit int32) SmbSharesecApiSmbSharesecGetRequest {
	r.limit = &limit
	return r
}

func (r SmbSharesecApiSmbSharesecGetRequest) Offset(offset int32) SmbSharesecApiSmbSharesecGetRequest {
	r.offset = &offset
	return r
}

func (r SmbSharesecApiSmbSharesecGetRequest) Count(count bool) SmbSharesecApiSmbSharesecGetRequest {
	r.count = &count
	return r
}

func (r SmbSharesecApiSmbSharesecGetRequest) Sort(sort string) SmbSharesecApiSmbSharesecGetRequest {
	r.sort = &sort
	return r
}

func (r SmbSharesecApiSmbSharesecGetRequest) Execute() (*http.Response, error) {
...
`query-options.extra` can be specified as query parameters with prefixing them with `extra.` prefix. For example, `extra.retrieve_properties=false` will pass `retrieve_properties` as an extra argument to pool/dataset endpoint.
 ...
 @return SmbSharesecApiSmbSharesecGetRequest
*/
func (a *SmbSharesecApiService) SmbSharesecGet(ctx context.Context) SmbSharesecApiSmbSharesecGetRequest {
	return SmbSharesecApiSmbSharesecGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SmbSharesecApiService) SmbSharesecGetExecute(r SmbSharesecApiSmbSharesecGetRequest) (*http.Response, error) {
	var (
...
type SmbSharesecApiSmbSharesecGetaclPostRequest struct {
	ctx               context.Context
	ApiService        *SmbSharesecApiService
	smbSharesecGetacl *SmbSharesecGetacl
}

func (r SmbSharesecApiSmbSharesecGetaclPostRequest) SmbSharesecGetacl(smbSharesecGetacl SmbSharesecGetacl) SmbSharesecApiSmbSharesecGetaclPostRequest {
	r.smbSharesecGetacl = &smbSharesecGetacl
	return r
}

func (r SmbSharesecApiSmbSharesecGetaclPostRequest) Execute() (*http.Response, error) {
...
contain names.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SmbSharesecApiSmbSharesecGetaclPostRequest
*/
func (a *SmbSharesecApiService) SmbSharesecGetaclPost(ctx context.Context) SmbSharesecApiSmbSharesecGetaclPostRequest {
	return SmbSharesecApiSmbSharesecGetaclPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecGetaclPostExecute(r SmbSharesecApiSmbSharesecGetaclPostRequest) (*http.Response, error) {
	var (
...
type SmbSharesecApiSmbSharesecIdIdDeleteRequest struct {
	ctx        context.Context
	ApiService *SmbSharesecApiService
	id         int32
}

func (r SmbSharesecApiSmbSharesecIdIdDeleteRequest) Execute() (*http.Response, error) {
...
Share can be deleted by name or numerical by numerical index.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return SmbSharesecApiSmbSharesecIdIdDeleteRequest
*/
func (a *SmbSharesecApiService) SmbSharesecIdIdDelete(ctx context.Context, id int32) SmbSharesecApiSmbSharesecIdIdDeleteRequest {
	return SmbSharesecApiSmbSharesecIdIdDeleteRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecIdIdDeleteExecute(r SmbSharesecApiSmbSharesecIdIdDeleteRequest) (*http.Response, error) {
	var (
...
type SmbSharesecApiSmbSharesecIdIdGetRequest struct {
	ctx        context.Context
	ApiService *SmbSharesecApiService
	id         int32
}

func (r SmbSharesecApiSmbSharesecIdIdGetRequest) Execute() (*http.Response, error) {
...
`query-options.extra` can be specified as query parameters with prefixing them with `extra.` prefix. For example, `extra.retrieve_properties=false` will pass `retrieve_properties` as an extra argument to pool/dataset endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return SmbSharesecApiSmbSharesecIdIdGetRequest
*/
func (a *SmbSharesecApiService) SmbSharesecIdIdGet(ctx context.Context, id int32) SmbSharesecApiSmbSharesecIdIdGetRequest {
	return SmbSharesecApiSmbSharesecIdIdGetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecIdIdGetExecute(r SmbSharesecApiSmbSharesecIdIdGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type SmbSharesecApiSmbSharesecIdIdPutRequest struct {
	ctx        context.Context
	ApiService *SmbSharesecApiService
	id         int32
}

func (r SmbSharesecApiSmbSharesecIdIdPutRequest) Execute() (*http.Response, error) {
...
to both /var/db/system/samba4/share_info.tdb and the configuration file.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return SmbSharesecApiSmbSharesecIdIdPutRequest
*/
func (a *SmbSharesecApiService) SmbSharesecIdIdPut(ctx context.Context, id int32) SmbSharesecApiSmbSharesecIdIdPutRequest {
	return SmbSharesecApiSmbSharesecIdIdPutRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecIdIdPutExecute(r SmbSharesecApiSmbSharesecIdIdPutRequest) (*http.Response, error) {
	var (
...
type SmbSharesecApiSmbSharesecPostRequest struct {
	ctx                context.Context
	ApiService         *SmbSharesecApiService
	smbSharesecCreate0 *SmbSharesecCreate0
}

func (r SmbSharesecApiSmbSharesecPostRequest) SmbSharesecCreate0(smbSharesecCreate0 SmbSharesecCreate0) SmbSharesecApiSmbSharesecPostRequest {
	r.smbSharesecCreate0 = &smbSharesecCreate0
	return r
}

func (r SmbSharesecApiSmbSharesecPostRequest) Execute() (*http.Response, error) {
...
`ae_type` can be ALLOWED or DENIED.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SmbSharesecApiSmbSharesecPostRequest
*/
func (a *SmbSharesecApiService) SmbSharesecPost(ctx context.Context) SmbSharesecApiSmbSharesecPostRequest {
	return SmbSharesecApiSmbSharesecPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecPostExecute(r SmbSharesecApiSmbSharesecPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest struct {
	ctx        context.Context
	ApiService *SmbSharesecApiService
}

func (r SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest) Execute() (*http.Response, error) {
...
share in share_info.tdb.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest
*/
func (a *SmbSharesecApiService) SmbSharesecSynchronizeAclsGet(ctx context.Context) SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest {
	return SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbSharesecApiService) SmbSharesecSynchronizeAclsGetExecute(r SmbSharesecApiSmbSharesecSynchronizeAclsGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
