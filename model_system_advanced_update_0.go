...
func (o *SystemAdvancedUpdate0) GetIsolatedGpuPciIds() []string {
	if o == nil || o.IsolatedGpuPciIds == nil {
		var ret []string
		return ret
	}
...
func (o *SystemAdvancedUpdate0) GetKernelExtraOptions() string {
	if o == nil || o.KernelExtraOptions == nil {
		var ret string
		return ret
	}
...
func (o SystemAdvancedUpdate0) MarshalJSON() ([]byte, error) {
	...
	if o.IsolatedGpuPciIds != nil {
		toSerialize["isolated_gpu_pci_ids"] = o.IsolatedGpuPciIds
	}
	if o.KernelExtraOptions != nil {
