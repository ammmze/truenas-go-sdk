...
type PoolDatasetApiPoolDatasetChangeKeyPostRequest struct {
	ctx                  context.Context
	ApiService           *PoolDatasetApiService
	poolDatasetChangeKey *PoolDatasetChangeKey
}

func (r PoolDatasetApiPoolDatasetChangeKeyPostRequest) PoolDatasetChangeKey(poolDatasetChangeKey PoolDatasetChangeKey) PoolDatasetApiPoolDatasetChangeKeyPostRequest {
	r.poolDatasetChangeKey = &poolDatasetChangeKey
	return r
}

func (r PoolDatasetApiPoolDatasetChangeKeyPostRequest) Execute() (*http.Response, error) {
...
A file might be uploaded to this endpoint. To upload a file, please send a multipart request with two parts. The first, named `data`, should contain a JSON-encoded payload, and the second, named `file`, should contain an uploaded file.
 ...
 @return PoolDatasetApiPoolDatasetChangeKeyPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetChangeKeyPost(ctx context.Context) PoolDatasetApiPoolDatasetChangeKeyPostRequest {
	return PoolDatasetApiPoolDatasetChangeKeyPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PoolDatasetApiService) PoolDatasetChangeKeyPostExecute(r PoolDatasetApiPoolDatasetChangeKeyPostRequest) (*http.Response, error) {
	var (
...
type PoolDatasetApiPoolDatasetChecksumChoicesGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
}

func (r PoolDatasetApiPoolDatasetChecksumChoicesGetRequest) Execute() (*http.Response, error) {
...
Retrieve checksums supported for ZFS dataset.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetChecksumChoicesGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetChecksumChoicesGet(ctx context.Context) PoolDatasetApiPoolDatasetChecksumChoicesGetRequest {
	return PoolDatasetApiPoolDatasetChecksumChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetChecksumChoicesGetExecute(r PoolDatasetApiPoolDatasetChecksumChoicesGetRequest) (*http.Response, error) {
	var (
...
type PoolDatasetApiPoolDatasetCompressionChoicesGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
}

func (r PoolDatasetApiPoolDatasetCompressionChoicesGetRequest) Execute() (*http.Response, error) {
...
Retrieve compression algorithm supported by ZFS.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetCompressionChoicesGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetCompressionChoicesGet(ctx context.Context) PoolDatasetApiPoolDatasetCompressionChoicesGetRequest {
	return PoolDatasetApiPoolDatasetCompressionChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetCompressionChoicesGetExecute(r PoolDatasetApiPoolDatasetCompressionChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest struct {
	ctx                         context.Context
	ApiService                  *PoolDatasetApiService
	poolDatasetDestroySnapshots *PoolDatasetDestroySnapshots
}

func (r PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest) PoolDatasetDestroySnapshots(poolDatasetDestroySnapshots PoolDatasetDestroySnapshots) PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest {
	r.poolDatasetDestroySnapshots = &poolDatasetDestroySnapshots
	return r
}

func (r PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest) Execute() (*http.Response, error) {
...
Destroy specified snapshots of a given dataset.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetDestroySnapshotsPost(ctx context.Context) PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest {
	return PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetDestroySnapshotsPostExecute(r PoolDatasetApiPoolDatasetDestroySnapshotsPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
}

func (r PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest) Execute() (*http.Response, error) {
...
Retrieve encryption algorithms supported for ZFS dataset encryption.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetEncryptionAlgorithmChoicesGet(ctx context.Context) PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest {
	return PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetEncryptionAlgorithmChoicesGetExecute(r PoolDatasetApiPoolDatasetEncryptionAlgorithmChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest struct {
	ctx                          context.Context
	ApiService                   *PoolDatasetApiService
	poolDatasetEncryptionSummary *PoolDatasetEncryptionSummary
}

func (r PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest) PoolDatasetEncryptionSummary(poolDatasetEncryptionSummary PoolDatasetEncryptionSummary) PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest {
	r.poolDatasetEncryptionSummary = &poolDatasetEncryptionSummary
	return r
}

func (r PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest) Execute() (*http.Response, error) {
...
A file might be uploaded to this endpoint. To upload a file, please send a multipart request with two parts. The first, named `data`, should contain a JSON-encoded payload, and the second, named `file`, should contain an uploaded file.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetEncryptionSummaryPost(ctx context.Context) PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest {
	return PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetEncryptionSummaryPostExecute(r PoolDatasetApiPoolDatasetEncryptionSummaryPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetExportKeyPostRequest struct {
	ctx                  context.Context
	ApiService           *PoolDatasetApiService
	poolDatasetExportKey *PoolDatasetExportKey
}

func (r PoolDatasetApiPoolDatasetExportKeyPostRequest) PoolDatasetExportKey(poolDatasetExportKey PoolDatasetExportKey) PoolDatasetApiPoolDatasetExportKeyPostRequest {
	r.poolDatasetExportKey = &poolDatasetExportKey
	return r
}

func (r PoolDatasetApiPoolDatasetExportKeyPostRequest) Execute() (*http.Response, error) {
...
A file might be downloaded from this endpoint. Please specify `?download=0` to fetch a method call result instead.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetExportKeyPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetExportKeyPost(ctx context.Context) PoolDatasetApiPoolDatasetExportKeyPostRequest {
	return PoolDatasetApiPoolDatasetExportKeyPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetExportKeyPostExecute(r PoolDatasetApiPoolDatasetExportKeyPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetExportKeysPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	body       *string
}

func (r PoolDatasetApiPoolDatasetExportKeysPostRequest) Body(body string) PoolDatasetApiPoolDatasetExportKeysPostRequest {
	r.body = &body
	return r
}

func (r PoolDatasetApiPoolDatasetExportKeysPostRequest) Execute() (*http.Response, error) {
...
A file will be downloaded from this endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetExportKeysPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetExportKeysPost(ctx context.Context) PoolDatasetApiPoolDatasetExportKeysPostRequest {
	return PoolDatasetApiPoolDatasetExportKeysPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetExportKeysPostExecute(r PoolDatasetApiPoolDatasetExportKeysPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	limit      *int32
	offset     *int32
...
func (r PoolDatasetApiPoolDatasetGetRequest) Limit(limit int32) PoolDatasetApiPoolDatasetGetRequest {
	r.limit = &limit
	return r
}

func (r PoolDatasetApiPoolDatasetGetRequest) Offset(offset int32) PoolDatasetApiPoolDatasetGetRequest {
	r.offset = &offset
	return r
}

func (r PoolDatasetApiPoolDatasetGetRequest) Count(count bool) PoolDatasetApiPoolDatasetGetRequest {
	r.count = &count
	return r
}

func (r PoolDatasetApiPoolDatasetGetRequest) Sort(sort string) PoolDatasetApiPoolDatasetGetRequest {
	r.sort = &sort
	return r
}

func (r PoolDatasetApiPoolDatasetGetRequest) Execute() (*http.Response, error) {
...
`query-options.extra` can be specified as query parameters with prefixing them with `extra.` prefix. For example, `extra.retrieve_properties=false` will pass `retrieve_properties` as an extra argument to pool/dataset endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetGet(ctx context.Context) PoolDatasetApiPoolDatasetGetRequest {
	return PoolDatasetApiPoolDatasetGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetGetExecute(r PoolDatasetApiPoolDatasetGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest) Execute() (*http.Response, error) {
...
[
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdAttachmentsPost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest {
	return PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdAttachmentsPostExecute(r PoolDatasetApiPoolDatasetIdIdAttachmentsPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdDeleteRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdDeleteRequest) Execute() (*http.Response, error) {
...
`force` will force delete busy datasets.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdDeleteRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdDelete(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdDeleteRequest {
	return PoolDatasetApiPoolDatasetIdIdDeleteRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdDeleteExecute(r PoolDatasetApiPoolDatasetIdIdDeleteRequest) (*http.Response, error) {
	var (
...
type PoolDatasetApiPoolDatasetIdIdGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdGetRequest) Execute() (*http.Response, error) {
...
`query-options.extra` can be specified as query parameters with prefixing them with `extra.` prefix. For example, `extra.retrieve_properties=false` will pass `retrieve_properties` as an extra argument to pool/dataset endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdGet(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdGetRequest {
	return PoolDatasetApiPoolDatasetIdIdGetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdGetExecute(r PoolDatasetApiPoolDatasetIdIdGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest) Execute() (*http.Response, error) {
...
in an on-disk quota of 1 KiB.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdGetQuotaPost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest {
	return PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdGetQuotaPostExecute(r PoolDatasetApiPoolDatasetIdIdGetQuotaPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdPermissionPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdPermissionPostRequest) Execute() (*http.Response, error) {
...
(child datasets).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdPermissionPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdPermissionPost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdPermissionPostRequest {
	return PoolDatasetApiPoolDatasetIdIdPermissionPostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdPermissionPostExecute(r PoolDatasetApiPoolDatasetIdIdPermissionPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdProcessesPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdProcessesPostRequest) Execute() (*http.Response, error) {
...
[
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdProcessesPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdProcessesPost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdProcessesPostRequest {
	return PoolDatasetApiPoolDatasetIdIdProcessesPostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdProcessesPostExecute(r PoolDatasetApiPoolDatasetIdIdProcessesPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdPromotePostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdPromotePostRequest) Execute() (*http.Response, error) {
...
Promote the cloned dataset `id`.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdPromotePostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdPromotePost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdPromotePostRequest {
	return PoolDatasetApiPoolDatasetIdIdPromotePostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdPromotePostExecute(r PoolDatasetApiPoolDatasetIdIdPromotePostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetIdIdPutRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdPutRequest) Execute() (*http.Response, error) {
...
Updates a dataset/zvol `id`.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdPutRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdPut(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdPutRequest {
	return PoolDatasetApiPoolDatasetIdIdPutRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdPutExecute(r PoolDatasetApiPoolDatasetIdIdPutRequest) (*http.Response, error) {
	var (
...
type PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	id         string
}

func (r PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest) Execute() (*http.Response, error) {
...
the user or group quota.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetIdIdSetQuotaPost(ctx context.Context, id string) PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest {
	return PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetIdIdSetQuotaPostExecute(r PoolDatasetApiPoolDatasetIdIdSetQuotaPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	body       *string
}

func (r PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest) Body(body string) PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest {
	r.body = &body
	return r
}

func (r PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest) Execute() (*http.Response, error) {
...
can only be done where `id` has an encrypted parent and `id` itself is an encryption root.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetInheritParentEncryptionPropertiesPost(ctx context.Context) PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest {
	return PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetInheritParentEncryptionPropertiesPostExecute(r PoolDatasetApiPoolDatasetInheritParentEncryptionPropertiesPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetLockPostRequest struct {
	ctx             context.Context
	ApiService      *PoolDatasetApiService
	poolDatasetLock *PoolDatasetLock
}

func (r PoolDatasetApiPoolDatasetLockPostRequest) PoolDatasetLock(poolDatasetLock PoolDatasetLock) PoolDatasetApiPoolDatasetLockPostRequest {
	r.poolDatasetLock = &poolDatasetLock
	return r
}

func (r PoolDatasetApiPoolDatasetLockPostRequest) Execute() (*http.Response, error) {
...
is unlocked, it will not be affected by this change and consumers can continue consuming it.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetLockPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetLockPost(ctx context.Context) PoolDatasetApiPoolDatasetLockPostRequest {
	return PoolDatasetApiPoolDatasetLockPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetLockPostExecute(r PoolDatasetApiPoolDatasetLockPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetPostRequest struct {
	ctx                context.Context
	ApiService         *PoolDatasetApiService
	poolDatasetCreate0 *PoolDatasetCreate0
}

func (r PoolDatasetApiPoolDatasetPostRequest) PoolDatasetCreate0(poolDatasetCreate0 PoolDatasetCreate0) PoolDatasetApiPoolDatasetPostRequest {
	r.poolDatasetCreate0 = &poolDatasetCreate0
	return r
}

func (r PoolDatasetApiPoolDatasetPostRequest) Execute() (*http.Response, error) {
...
with a passphrase as a key.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetPost(ctx context.Context) PoolDatasetApiPoolDatasetPostRequest {
	return PoolDatasetApiPoolDatasetPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetPostExecute(r PoolDatasetApiPoolDatasetPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	body       *string
}

func (r PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest) Body(body string) PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest {
	r.body = &body
	return r
}

func (r PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest) Execute() (*http.Response, error) {
...
Helper method to get recommended size for a new zvol (dataset of type VOLUME).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetRecommendedZvolBlocksizePost(ctx context.Context) PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest {
	return PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetRecommendedZvolBlocksizePostExecute(r PoolDatasetApiPoolDatasetRecommendedZvolBlocksizePostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
}

func (r PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest) Execute() (*http.Response, error) {
...
PoolDatasetRecordsizeChoicesGet Method for PoolDatasetRecordsizeChoicesGet
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest
*/
func (a *PoolDatasetApiService) PoolDatasetRecordsizeChoicesGet(ctx context.Context) PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest {
	return PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetRecordsizeChoicesGetExecute(r PoolDatasetApiPoolDatasetRecordsizeChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetUnlockPostRequest struct {
	ctx               context.Context
	ApiService        *PoolDatasetApiService
	poolDatasetUnlock *PoolDatasetUnlock
}

func (r PoolDatasetApiPoolDatasetUnlockPostRequest) PoolDatasetUnlock(poolDatasetUnlock PoolDatasetUnlock) PoolDatasetApiPoolDatasetUnlockPostRequest {
	r.poolDatasetUnlock = &poolDatasetUnlock
	return r
}

func (r PoolDatasetApiPoolDatasetUnlockPostRequest) Execute() (*http.Response, error) {
...
A file might be uploaded to this endpoint. To upload a file, please send a multipart request with two parts. The first, named `data`, should contain a JSON-encoded payload, and the second, named `file`, should contain an uploaded file.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetUnlockPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetUnlockPost(ctx context.Context) PoolDatasetApiPoolDatasetUnlockPostRequest {
	return PoolDatasetApiPoolDatasetUnlockPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetUnlockPostExecute(r PoolDatasetApiPoolDatasetUnlockPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
type PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest struct {
	ctx        context.Context
	ApiService *PoolDatasetApiService
	body       *string
}

func (r PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest) Body(body string) PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest {
	r.body = &body
	return r
}

func (r PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest) Execute() (*http.Response, error) {
...
Get a mapping of services identifiers and labels that can be restart on dataset unlock.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest
*/
func (a *PoolDatasetApiService) PoolDatasetUnlockServicesRestartChoicesPost(ctx context.Context) PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest {
	return PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *PoolDatasetApiService) PoolDatasetUnlockServicesRestartChoicesPostExecute(r PoolDatasetApiPoolDatasetUnlockServicesRestartChoicesPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
