...
type S3ApiS3BindipChoicesGetRequest struct {
	ctx        context.Context
	ApiService *S3ApiService
}

func (r S3ApiS3BindipChoicesGetRequest) Execute() (*http.Response, error) {
...
Return ip choices for S3 service to use.
 ...
 @return S3ApiS3BindipChoicesGetRequest
*/
func (a *S3ApiService) S3BindipChoicesGet(ctx context.Context) S3ApiS3BindipChoicesGetRequest {
	return S3ApiS3BindipChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *S3ApiService) S3BindipChoicesGetExecute(r S3ApiS3BindipChoicesGetRequest) (*http.Response, error) {
	var (
...
type S3ApiS3GetRequest struct {
	ctx        context.Context
	ApiService *S3ApiService
}

func (r S3ApiS3GetRequest) Execute() (*http.Response, error) {
...
S3Get Method for S3Get
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return S3ApiS3GetRequest
*/
func (a *S3ApiService) S3Get(ctx context.Context) S3ApiS3GetRequest {
	return S3ApiS3GetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *S3ApiService) S3GetExecute(r S3ApiS3GetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type S3ApiS3PutRequest struct {
	ctx        context.Context
	ApiService *S3ApiService
	s3Update0  *S3Update0
}

func (r S3ApiS3PutRequest) S3Update0(s3Update0 S3Update0) S3ApiS3PutRequest {
	r.s3Update0 = &s3Update0
	return r
}

func (r S3ApiS3PutRequest) Execute() (*http.Response, error) {
...
S3 connections.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return S3ApiS3PutRequest
*/
func (a *S3ApiService) S3Put(ctx context.Context) S3ApiS3PutRequest {
	return S3ApiS3PutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *S3ApiService) S3PutExecute(r S3ApiS3PutRequest) (*http.Response, error) {
	var (
