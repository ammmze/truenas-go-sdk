...
func NewPoolDatasetCreate0() *PoolDatasetCreate0 {
	...
	var type_ string = "FILESYSTEM"
	this.Type = &type_
	var shareType string = "GENERIC"
	this.ShareType = &shareType
	var xattr string = "SA"
	this.Xattr = &xattr
	var encryption bool = false
	this.Encryption = &encryption
	var inheritEncryption bool = true
	this.InheritEncryption = &inheritEncryption
	var createAncestors bool = false
...
func (o *PoolDatasetCreate0) GetCreateAncestors() bool {
	if o == nil || o.CreateAncestors == nil {
		var ret bool
		return ret
	}
