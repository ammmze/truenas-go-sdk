...
type UpsApiUpsDriverChoicesGetRequest struct {
	ctx        context.Context
	ApiService *UpsApiService
}

func (r UpsApiUpsDriverChoicesGetRequest) Execute() (*http.Response, error) {
...
Returns choices of UPS drivers supported by the system.
 ...
 @return UpsApiUpsDriverChoicesGetRequest
*/
func (a *UpsApiService) UpsDriverChoicesGet(ctx context.Context) UpsApiUpsDriverChoicesGetRequest {
	return UpsApiUpsDriverChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *UpsApiService) UpsDriverChoicesGetExecute(r UpsApiUpsDriverChoicesGetRequest) (*http.Response, error) {
	var (
...
type UpsApiUpsGetRequest struct {
	ctx        context.Context
	ApiService *UpsApiService
}

func (r UpsApiUpsGetRequest) Execute() (*http.Response, error) {
...
UpsGet Method for UpsGet
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UpsApiUpsGetRequest
*/
func (a *UpsApiService) UpsGet(ctx context.Context) UpsApiUpsGetRequest {
	return UpsApiUpsGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *UpsApiService) UpsGetExecute(r UpsApiUpsGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type UpsApiUpsPortChoicesGetRequest struct {
	ctx        context.Context
	ApiService *UpsApiService
}

func (r UpsApiUpsPortChoicesGetRequest) Execute() (*http.Response, error) {
...
UpsPortChoicesGet Method for UpsPortChoicesGet
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UpsApiUpsPortChoicesGetRequest
*/
func (a *UpsApiService) UpsPortChoicesGet(ctx context.Context) UpsApiUpsPortChoicesGetRequest {
	return UpsApiUpsPortChoicesGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *UpsApiService) UpsPortChoicesGetExecute(r UpsApiUpsPortChoicesGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
type UpsApiUpsPutRequest struct {
	ctx        context.Context
	ApiService *UpsApiService
	upsUpdate0 *UpsUpdate0
}

func (r UpsApiUpsPutRequest) UpsUpdate0(upsUpdate0 UpsUpdate0) UpsApiUpsPutRequest {
	r.upsUpdate0 = &upsUpdate0
	return r
}

func (r UpsApiUpsPutRequest) Execute() (*http.Response, error) {
...
`shutdowncmd` is the command which is executed to initiate a shutdown. It defaults to "poweroff".
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UpsApiUpsPutRequest
*/
func (a *UpsApiService) UpsPut(ctx context.Context) UpsApiUpsPutRequest {
	return UpsApiUpsPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *UpsApiService) UpsPutExecute(r UpsApiUpsPutRequest) (*http.Response, error) {
	var (
